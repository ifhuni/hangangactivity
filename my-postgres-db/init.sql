...
COMMENT ON COLUMN public.activities.activity_type IS '활동 유형(실내/실외)';
...
VALUES 
(1, '투어 SUP 기초 클래스', '한강에서 SUP 기본 자세와 안전 수칙을 배우는 입문 프로그램입니다.', '서울 영등포구 여의도한강공원', 'OUT', 20, '2025-08-01', '09:00:00', '10:00:00'),
(1, '노을 요가 세션', '해질녘 한강 뷰를 바라보며 진행하는 힐링 요가 시간입니다.', '서울 영등포구 여의도한강공원', 'OUT', 20, '2025-08-01', '18:00:00', '19:00:00'),
(2, '도심 카약 투어', '전문 강사와 함께하는 야간 한강 카약 투어 프로그램입니다.', '서울 마포구 망원한강공원', 'OUT', 16, '2025-08-06', '20:00:00', '21:30:00'),
(2, '실내 패들 보강반', '기초를 마친 회원을 위한 균형 감각 및 근력 강화 프로그램입니다.', '서울 마포구 서교동 연습장', 'IN', 12, '2025-08-07', '13:00:00', '14:30:00'),
(3, '수상 안전 교육', '현직 구조대 출신 강사가 진행하는 수상 안전 이론 및 실습 과정입니다.', '서울 광진구 자양한강공원', 'OUT', 25, '2025-08-03', '07:30:00', '09:00:00'),
(3, '선셋 보트 파티', '음악과 다과가 마련된 선셋 크루즈 체험 프로그램입니다.', '서울 광진구 자양한강공원', 'OUT', 30, '2025-08-08', '19:00:00', '21:00:00'),
(3, '프라이빗 요트 라운지', '소규모 인원으로 즐기는 프라이빗 요트 라운지 패키지입니다.', '서울 광진구 자양한강공원', 'OUT', 10, '2025-08-09', '15:00:00', '17:00:00'),
(3, '아침 조깅 모임', '강변을 따라 달리며 체력을 기르는 무료 조깅 커뮤니티입니다.', '서울 광진구 자양한강공원', 'OUT', 40, '2025-08-10', '06:30:00', '07:30:00');
